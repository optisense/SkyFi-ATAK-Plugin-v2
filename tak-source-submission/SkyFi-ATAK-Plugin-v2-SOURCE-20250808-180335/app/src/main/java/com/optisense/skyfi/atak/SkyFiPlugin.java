...
import com.optisense.skyfi.atak.skyfiapi.Pong;
...
public class SkyFiPlugin implements MainRecyclerViewAdapter.ItemClickListener {
    ...
    private void updateDashboardMetrics() {
        ...
        apiClient.ping().enqueue(new Callback<com.optisense.skyfi.atak.skyfiapi.Pong>() {
            @Override
            public void onResponse(Call<com.optisense.skyfi.atak.skyfiapi.Pong> call, 
                                 Response<com.optisense.skyfi.atak.skyfiapi.Pong> response) {
            ...
            @Override
            public void onFailure(Call<com.optisense.skyfi.atak.skyfiapi.Pong> call, Throwable t) {
                MapView.getMapView().post(() -> {
        ...
        apiClient.getOrders(0, 100).enqueue(new Callback<com.optisense.skyfi.atak.skyfiapi.OrderResponse>() {
            @Override
            public void onResponse(Call<com.optisense.skyfi.atak.skyfiapi.OrderResponse> call,
                                 Response<com.optisense.skyfi.atak.skyfiapi.OrderResponse> response) {
                if (response.isSuccessful() && response.body() != null && response.body().getOrders() != null) {
                    int activeCount = 0;
                    for (com.optisense.skyfi.atak.skyfiapi.Order order : response.body().getOrders()) {
            ...
            @Override
            public void onFailure(Call<com.optisense.skyfi.atak.skyfiapi.OrderResponse> call, Throwable t) {
