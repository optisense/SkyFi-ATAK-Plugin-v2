...
public class DashboardDropDownReceiver extends DropDownReceiver {
    ...
    private void updateDashboardMetrics() {
        ...
        if (plugin.apiClient != null) {
            plugin.apiClient.ping().enqueue(new Callback<com.optisense.skyfi.atak.skyfiapi.Pong>() {
                @Override
        ...
        if (plugin.apiClient != null) {
            plugin.apiClient.getOrders(0, 100).enqueue(new Callback<com.optisense.skyfi.atak.skyfiapi.OrderResponse>() {
                @Override
