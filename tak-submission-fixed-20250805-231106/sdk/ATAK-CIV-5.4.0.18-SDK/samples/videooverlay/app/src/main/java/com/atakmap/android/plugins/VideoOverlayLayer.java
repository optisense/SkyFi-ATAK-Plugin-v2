 ...
 * @author Developer
 */
public class VideoOverlayLayer extends AbstractLayer implements VideoConsumer,
        KLVConsumer {
    ...
    public VideoOverlayLayer(String name, String uri) {
        super(name);
     ...
     */
    public synchronized void seek(long timestampMillis) {
        if (this.proc != null) {
    ...
    private void dispatchVideoFrameNoSync() {
        ...
        if (this.listener != null && this.haveMeta && this.haveVideo)
            this.listener.videoFrame(this.frameRGB, this.frameWidth,
                    this.frameHeight, this.upperLeft, this.upperRight,
    ...
    public static interface VideoFrameListener {
         ...
         * 
         * @param rgb           The video frame data, as packed ARGB 32-bit
         *                      ints. The offset is always <code>0</code> and
         *                      stride is always equal to <code>width</code>.
         ...
         *                      is not available.
         */
        public void videoFrame(int[] rgb, int width, int height,
