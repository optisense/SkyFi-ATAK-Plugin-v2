...
public class GLOSMBuildingsUnbatched
    ...
    public final static GLLayerSpi2 SPI = new GLLayerSpi2() {
        ...
        public GLLayer2 create(Pair<MapRenderer, Layer> object) {
            ...
            return new GLOSMBuildingsUnbatched(renderCtx,
    ...
    public GLOSMBuildingsUnbatched(MapRenderer surface,
        ...
        this.renderList = this.renderables.values();
    }
