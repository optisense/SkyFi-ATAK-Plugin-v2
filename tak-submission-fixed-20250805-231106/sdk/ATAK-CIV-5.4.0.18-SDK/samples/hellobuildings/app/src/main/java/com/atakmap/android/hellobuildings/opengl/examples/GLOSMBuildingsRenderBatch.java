...
public class GLOSMBuildingsRenderBatch
    ...
    public final static GLLayerSpi2 SPI = new GLLayerSpi2() {
        ...
        public GLLayer2 create(Pair<MapRenderer, Layer> object) {
            ...
            return new GLOSMBuildingsRenderBatch(renderCtx,
    ...
    private GLBuildingRenderBatch renderBatchRenderer;
    private boolean visible;

    public GLOSMBuildingsRenderBatch(MapRenderer surface,
        ...
        this.renderBatchRenderer = new GLBuildingRenderBatch();
        this.renderBatchRenderer.polys = this.renderables.values();

        this.renderList = Collections.singleton(renderBatchRenderer);
    }
