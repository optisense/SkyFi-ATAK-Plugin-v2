...
public class GLBuildingsExample
    ...
    public final static GLLayerSpi2 SPI = new GLLayerSpi2() {
        ...
        public GLLayer2 create(Pair<MapRenderer, Layer> object) {
            ...
            return new GLBuildingsExample(renderCtx, (BuildingsExample) layer);
        }
    };
    ...
    public GLBuildingsExample(MapRenderer surface, BuildingsExample subject) {
        ...
        this.modelControl = new ModelControl() {
            ...
            public void setVisible(int mask) {
                cacheBatchRenderer.textured = MathUtils.hasBits(mask, TEXTURE);
                cacheBatchRenderer.wireFrame = MathUtils.hasBits(mask,
                        WIREFRAME);
            }
            ...
            public int getVisible() {
                int retval = 0;
                if (cacheBatchRenderer.textured)
                    retval |= TEXTURE;
                if (cacheBatchRenderer.wireFrame)
                    retval |= WIREFRAME;
                return retval;
            }
        };
    ...
    public void start() {
        ...
        this.renderContext.registerControl((BuildingsExample) this.subject,
                this.modelControl);
    ...
    @Override
    public void stop() {
        this.renderContext.unregisterControl((BuildingsExample) this.subject,
                this.modelControl);
    ...
    protected boolean updateRenderList(
        ...
        if (!toRelease.isEmpty()) {
            this.renderContext.queueEvent(new Runnable() {
                public void run() {
                    for (Releasable r : toRelease.values())
                        r.release();
                }
            });
        }
    ...
    private void queryImpl(double northBound,
        ...
        try {
            ...
            //params.spatialFilter = new FeatureDataStore.FeatureQueryParameters.RegionSpatialFilter(new GeoPoint(northBound, westBound), new GeoPoint(southBound, eastBound));
            ...
            Log.w("GLBuildingsExample",
                    "Data Store error occured querying features", e);
        } finally {
            if (result != null)
                result.close();
        }
    ...
    public void onFeatureInserted(FeatureDataStore2 dataStore, long fid,
        ...
        this.onDataStoreContentChanged(dataStore);
    }
