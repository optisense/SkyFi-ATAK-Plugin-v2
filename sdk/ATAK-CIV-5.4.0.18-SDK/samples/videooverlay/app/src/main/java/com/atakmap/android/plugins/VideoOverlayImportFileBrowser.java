...
public class VideoOverlayImportFileBrowser extends LinearLayout {

    /*************************** CONSTRUCTORS **************************/

    public VideoOverlayImportFileBrowser(Context context) {
        super(context);
    }

    public VideoOverlayImportFileBrowser(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
