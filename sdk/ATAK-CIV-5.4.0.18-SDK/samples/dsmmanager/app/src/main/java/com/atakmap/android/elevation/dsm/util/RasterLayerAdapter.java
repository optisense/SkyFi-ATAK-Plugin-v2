...
public final class RasterLayerAdapter implements RasterLayer2 {
    ...
    @Override
    public void addOnPreferredProjectionChangedListener(
            OnPreferredProjectionChangedListener l) {
    }

    @Override
    public void removeOnPreferredProjectionChangedListener(
            OnPreferredProjectionChangedListener l) {
    }
    ...
    @Override
    public void addOnSelectionVisibleChangedListener(
            OnSelectionVisibleChangedListener l) {
    }

    @Override
    public void removeOnSelectionVisibleChangedListener(
            OnSelectionVisibleChangedListener l) {
    }
    ...
    @Override
    public void addOnSelectionTransparencyChangedListener(
            OnSelectionTransparencyChangedListener l) {
    }

    @Override
    public void removeOnSelectionTransparencyChangedListener(
            OnSelectionTransparencyChangedListener l) {
    }
}
