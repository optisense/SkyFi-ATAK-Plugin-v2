...
public class VideoMosaicView extends LinearLayout {
    ...
    private VideoMosaicAdapter _adapter;
    ...
    */
    ...
    public VideoMosaicView(Context context, AttributeSet attrs) {
        super(context, attrs);

        defaultPrefs = PreferenceManager.getDefaultSharedPreferences(context);
    }

    public VideoMosaicAdapter getAdapter() {
        return _adapter;
    }

    void initView(MapView mapView, VideoMosaicManager mgr) {
        _mapView = mapView;
        ...
        _adapter = new VideoMosaicAdapter(_mapView, this, mgr);
        _list.setAdapter(_adapter);
    }

    private void importLocalFile() {
        LayoutInflater inflater = LayoutInflater.from(this.getContext());
        final VideoManagerFileBrowser importView = (VideoManagerFileBrowser) inflater
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (selectedFiles.size() == 0) {
                    ...
                    final Importer importer = ImporterManager.findImporter(
                            VideoImporter.CONTENT_TYPE,
                            VideoImporter.MPEG2_TS_MIME);
                    if (importer != null) {
