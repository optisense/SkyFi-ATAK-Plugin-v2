...
public class Profile extends DropDownReceiver implements DropDown.OnStateListener {
    ...
    public void onReceive(Context context, Intent intent) {
        Log.d(LOGTAG, "Profile dropdown received broadcast");
        if (intent.getAction() != null && intent.getAction().equals(ACTION)) {
            ...
            Log.d(LOGTAG, "showDropDown called successfully with setRetain(true)");
